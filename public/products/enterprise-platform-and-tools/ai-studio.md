...
For a comprehensive list of options to deploy and consume Mistral AI models on the cloud, head on to the **[cloud deployment section](/operations/deployment-and-operations/cloud)**.

<SectionTab as="h1" sectionId="raw-model-weights">Raw model weights</SectionTab>

Raw model weights can be used in several ways: 
- For self-deployment, on cloud or on premise, using either [TensorRT-LLM](/operations/deployment-and-operations/self-deployment/trt) or [vLLM](/operations/deployment-and-operations/self-deployment/vllm), head on to **[Deployment](/operations/deployment-and-operations/self-deployment/skypilot)**
