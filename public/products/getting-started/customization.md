...
*We provide a few developer examples of model customization via Fine-Tuning [here](/cookbooks?useCase=Finetuning).*
...
Check out our [fine-tuning doc](/capabilities/finetuning) to learn the benefits of fine-tuning and how to use our fine-tuning API.
